                            ...
                            <div className='product-search-feed  x mandatory-scroll-snapping' id='product-search-feed'>
                                {
                                    ...
                                    searchResults.map((product, i) => {
                                        return <ProductCard searchProduct={true} handleSearchClose={handleSearchClose} setWishlistPopup={setWishlistPopup} setWishlistBubble={setWishlistBubble} setWishList={setWishList} cart={cart} setCart={setCart} product={product} /> 
                                    }) 
                                    :
                                    <></>
                                }
