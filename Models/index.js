...
// Google and Wishlist one-to-one association
db.oAuthUsers.hasOne(db.wishlist);
db.wishlist.belongsTo(db.oAuthUsers);
...
(async () => {
    await db.sequelize.sync({ force: true }).then(() => {
        ...
        Products.create({ id: 43, name: "Black Active Boxy Athletic Back Print T-shirt", price: 25, salePrice: null, clothingType: 'tops', category: "t-shirts", gender: 'men', color: 'black', new: true });
        ...
        Products.create({ id: 45, name: "Blue Active Logo Performance T-shirt", price: 25, salePrice: null, clothingType: 'tops', category: "t-shirts", gender: 'men', color: 'blue', new: false });
        Products.create({ id: 46, name: "Dark Orange Active Gym Raglan T-shirt", price: 20, salePrice: 15, clothingType: 'tops', category: "t-shirts", gender: 'men', color: 'orange', new: false });
        Products.create({ id: 47, name: "Orange Active Gym Raglan T-shirt-3", price: 22, salePrice: null, clothingType: 'tops', category: "t-shirts", gender: 'men', color: 'orange', new: false });
        ...
        Products.create({ id: 49, name: "Teal Man Active Performance T-shirt", price: 25, salePrice: null, clothingType: 'tops', category: "t-shirts", gender: 'men', color: 'green', new: true });
        Products.create({ id: 50, name: "White Active Gym Oversized Rep T-shirt", price: 30, salePrice: 25, clothingType: 'tops', category: "t-shirts", gender: 'men', color: 'white', new: false });
        Products.create({ id: 51, name: "Sand Active Oversized One More Rep T-shirt", price: 15, salePrice: null, clothingType: 'tops', category: "t-shirts", gender: 'men', color: 'yellow', new: false });
        

        // long sleeves
        Products.create({ id: 5, name: "Khaki Active Raglan Muscle Fit Compression Top", price: 30, salePrice: null, clothingType: 'tops', category: "long sleeves", gender: 'men', color: 'green', new: true });
        ...
        Products.create({ id: 53, name: "Cobalt Active Muscle Fit Long Sleeved Top", price: 25, salePrice: 20, clothingType: 'tops', category: "long sleeves", gender: 'men', color: 'blue', new: false });
        Products.create({ id: 54, name: "Green Active Seamless Long Sleeve Top", price: 20, salePrice: 15, clothingType: 'tops', category: "long sleeves", gender: 'men', color: 'green', new: false });


        // Hoodies
        Products.create({ id: 101, name: "Black Active Super Flex Zip Through Hoodie", price: 35, salePrice: null, clothingType: 'tops', category: "hoodies", gender: 'men', color: 'gray', new: true });
        Products.create({ id: 102, name: "Green Active Training Dept Boxy Hoodie", price: 25, salePrice: 20, clothingType: 'tops', category: "hoodies", gender: 'men', color: 'green', new: false });
        ...
        Products.create({ id: 104, name: "Khaki Man Active Washed Zip Up Rest Day Hoodie", price: 20, salePrice: null, clothingType: 'tops', category: "hoodies", gender: 'men', color: 'green', new: true });
        Products.create({ id: 105, name: "Chocolate Man Active Training Dept Boxy Hoodie", price: 25, salePrice: 20, clothingType: 'tops', category: "hoodies", gender: 'men', color: 'brown', new: false });
        ...
        Products.create({ id: 36, name: "Black Active Lightweight Cargo Shorts", price: 35, salePrice: null, clothingType: 'bottoms', category: "shorts", gender: 'men', color: 'black', new: true });
        ...
        Products.create({ id: 56, name: "Gray Man Active Extreme Split 3inch 2-in-1 Short", price: 25, salePrice: null, clothingType: 'bottoms', category: "shorts", gender: 'men', color: 'gray', new: true });
        Products.create({ id: 57, name: "Khaki Man Active Performance 5inch 2-in-1 Shorts", price: 20, salePrice: null, clothingType: 'bottoms', category: "shorts", gender: 'men', color: 'green', new: false });
        Products.create({ id: 113, name: "Charcoal Man Active Mesh Panelled 2-in-1 Shorts", price: 15, salePrice: null, clothingType: 'bottoms', category: "shorts", gender: 'men', color: 'black', new: false });

        // sweatpants
        Products.create({ id: 108, name: "Gray Marl Man Active Oversized Body Building Sweatpants", price: 20, salePrice: null, clothingType: 'bottoms', category: "sweatpants", gender: 'men', color: 'gray', new: false });
        Products.create({ id: 109, name: "Black Man Active Oversized Bronx Gym Sweatpants", price: 25, salePrice: null, clothingType: 'bottoms', category: "sweatpants", gender: 'men', color: 'black', new: false });
        Products.create({ id: 110, name: "Khaki Man Active Oversized Training Dept Sweatpants", price: 20, salePrice: null, clothingType: 'bottoms', category: "sweatpants", gender: 'men', color: 'green', new: false });
        Products.create({ id: 111, name: "Blue Man Active Washed Rest Day Jogger", price: 30, salePrice: null, clothingType: 'bottoms', category: "sweatpants", gender: 'men', color: 'blue', new: true });
        Products.create({ id: 112, name: "Khaki Man Active Washed Rest Day Jogger", price: 30, salePrice: null, clothingType: 'bottoms', category: "sweatpants", gender: 'men', color: 'green', new: true });
        ...
        Products.create({ id: 17, name: "Gray DSGN Studio Supersoft Peached Sculpt Padded Sports Bra", price: 30, salePrice: 25, clothingType: 'tops', category: "sports bras", gender: 'women', color: 'gray', new: false });
        ...
        Products.create({ id: 67, name: "Black Premium Sculpt Reform Padded Sports Bra", price: 20, salePrice: 15, clothingType: 'tops', category: "sports bras", gender: 'women', color: 'black', new: false });
        Products.create({ id: 68, name: "Black Seamless Rib Longline Sports Bra", price: 35, salePrice: 25, clothingType: 'tops', category: "sports bras", gender: 'women', color: 'black', new: false });
        Products.create({ id: 69, name: "Pink Premium Sculpt Reform Padded Sports Bra", price: 25, salePrice: 20, clothingType: 'tops', category: "sports bras", gender: 'women', color: 'pink', new: false });

        // t-shirts
        Products.create({ id: 19, name: "White Ath Dept Slogan Oversized T-Shirt", price: 25, salePrice: 20, clothingType: 'tops', category: "t-shirts", gender: 'women', color: 'white', new: false });
        Products.create({ id: 20, name: "Beige DSGN Studio Supersoft Peached Sculpt Top", price: 25, salePrice: null, clothingType: 'tops', category: "t-shirts", gender: 'women', color: 'brown', new: true });
        ...
        Products.create({ id: 58, name: "Black DSGN Studio Supersoft Peached Sculpt Top", price: 25, salePrice: null, clothingType: 'tops', category: "t-shirts", gender: 'women', color: 'black', new: true });
        Products.create({ id: 59, name: "Pink Sports Club Slogan Oversized T-Shirt", price: 35, salePrice: 25, clothingType: 'tops', category: "t-shirts", gender: 'women', color: 'pink', new: false });
        ...
        Products.create({ id: 25, name: "Ribbed Seamless Long Sleeve Gym Top", price: 25, salePrice: 20, clothingType: 'tops', category: "long sleeves", gender: 'women', color: 'gray', new: false });
        ...
        Products.create({ id: 64, name: "Blue DSGN Woven Label Long Sleeve Active Gym Crop Top", price: 25, salePrice: null, clothingType: 'tops', category: "long sleeves", gender: 'women', color: 'blue', new: false });
        Products.create({ id: 65, name: "Black DSGN Woven Label Long Sleeve Active Gym Crop Top", price: 30, salePrice: null, clothingType: 'tops', category: "long sleeves", gender: 'women', color: 'black', new: false });

        // hoodiess
        Products.create({ id: 83, name: "Black Reflective DSGN Studio Hoodie", price: 25, salePrice: null, clothingType: 'tops', category: "hoodies", gender: 'women', color: 'black', new: true });
        Products.create({ id: 84, name: "Green DSGN Sports Puff Print Slogan Hoodie", price: 30, salePrice: 24, clothingType: 'tops', category: "hoodies", gender: 'women', color: 'green', new: false });
        Products.create({ id: 85, name: "Pink Petite DSGN Studio Text Print Hoodie", price: 30, salePrice: null, clothingType: 'tops', category: "hoodies", gender: 'women', color: 'pink', new: true });
        ...
        Products.create({ id: 87, name: "Blue DSGN Studio Oversized Hoodie", price: 35, salePrice: null, clothingType: 'tops', category: "hoodies", gender: 'women', color: 'blue', new: true });
        Products.create({ id: 88, name: "Dark Gray DSGN Studio Oversized Hoodie", price: 35, salePrice: null, clothingType: 'tops', category: "hoodies", gender: 'women', color: 'gray', new: true });
        ...
        Products.create({ id: 90, name: "White Recycled Hoodie", price: 20, salePrice: 15, clothingType: 'tops', category: "hoodies", gender: 'women', color: 'white', new: false });
        ...
        Products.create({ id: 92, name: "Gray Zip Hoodie", price: 22, salePrice: null, clothingType: 'tops', category: "hoodies", gender: 'women', color: 'gray', new: false });
        Products.create({ id: 93, name: "Black Zip Hoodie", price: 22, salePrice: null, clothingType: 'tops', category: "hoodies", gender: 'women', color: 'black', new: false });
        ...
        Products.create({ id: 95, name: "Gray Petite DSGN Studio Acid Wash Hoodie", price: 35, salePrice: null, clothingType: 'tops', category: "hoodies", gender: 'women', color: 'gray', new: false });

        // WOMEN BOTTOMS

        // leggings
        Products.create({ id: 26, name: "Black DSGN STUDIO Piping Detail Peached Active Legging", price: 35, salePrice: null, clothingType: 'bottoms', category: "leggings", gender: 'women', color: 'black', new: true });
        ...
        Products.create({ id: 28, name: "Red Honeycomb Workout Leggings", price: 30, salePrice: 25, clothingType: 'bottoms', category: "leggings", gender: 'women', color: 'red', new: false });
        ...
        Products.create({ id: 31, name: "Black DSGN Studio Sports Workout Leggings With Pocket", price: 20, salePrice: null, clothingType: 'bottoms', category: "leggings", gender: 'women', color: 'black', new: false });
        ...
        Products.create({ id: 76, name: "Brown Rib Seam Detail Flared Legging", price: 30, salePrice: null, clothingType: 'bottoms', category: "leggings", gender: 'women', color: 'brown', new: true });
        ...
        Products.create({ id: 78, name: "Black Premium Sculpt Reform Capri Leggings", price: 30, salePrice: 20, clothingType: 'bottoms', category: "leggings", gender: 'women', color: 'black', new: false });
        Products.create({ id: 79, name: "Purple Tall Honeycomb Leggings", price: 25, salePrice: null, clothingType: 'bottoms', category: "leggings", gender: 'women', color: 'purple', new: true });
        Products.create({ id: 80, name: "Brown Premium Sculpt Reform Capri Leggings", price: 25, salePrice: 15, clothingType: 'bottoms', category: "leggings", gender: 'women', color: 'brown', new: false });
        ...
        Products.create({ id: 33, name: "Charcoal Seamless Contour Ribbed Biker Shorts", price: 30, salePrice: 24, clothingType: 'bottoms', category: "shorts", gender: 'women', color: 'gray', new: false });
        ...
        Products.create({ id: 72, name: "Red Running Shorts", price: 20, salePrice: 15, clothingType: 'bottoms', category: "shorts", gender: 'women', color: 'red', new: false });
        Products.create({ id: 73, name: "Black Running Shorts", price: 20, salePrice: 15, clothingType: 'bottoms', category: "shorts", gender: 'women', color: 'black', new: false });
        ...
        Products.create({ id: 97, name: "Blue Washed Oversized Joggers", price: 30, salePrice: 20, clothingType: 'bottoms', category: "sweatpants", gender: 'women', color: 'blue', new: false });
        Products.create({ id: 98, name: "Brown Washed Oversized Joggers", price: 25, salePrice: 20, clothingType: 'bottoms', category: "sweatpants", gender: 'women', color: 'brown', new: false });
        ...
        Products.create({ id: 100, name: "Black Washed Oversized Joggers", price: 18, salePrice: null, clothingType: 'bottoms', category: "sweatpants", gender: 'women', color: 'black', new: false });
