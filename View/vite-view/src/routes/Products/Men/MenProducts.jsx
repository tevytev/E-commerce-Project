...
export default function MenProducts(props) {
      ...
      if (priceFilter) {
        try {
          const response = await axios.get(
            `api/products/clothingType/${product}?gender=men&priceFilter=${priceFilter}`,
            {
              headers: {
        ...
        try {
          const response = await axios.get(
            `api/products/clothingType/${product}?gender=men`,
            {
              headers: {
                "Content-Type": "application/json",
              },
  ...
  const topsProductTypeBtns = [
    <button onClick={changeProduct} id="tops">
      All
    </button>,
    <button onClick={changeProductType} id="t-shirts">
      T-shirts
    </button>,
    <button onClick={changeProductType} id="long sleeves">
      Long Sleeve
    </button>,
    <button onClick={changeProductType} id="hoodies">
      Hoodies
    </button>,
  ];

  const bottomsProductTypeBtns = [
    <button onClick={changeProduct} id="bottoms">
      All
    </button>,
    <button onClick={changeProductType} id="shorts">
      Shorts
    </button>,
    <button onClick={changeProductType} id="pants">
      Pants
    </button>,
    <button onClick={changeProductType} id="sweatpants">
      Sweatpants
    </button>,
  ];
  ...
  const onCollapseClick = (e) => {
    ...
    const arrow =
      e.target.children[
        document.getElementById("responsive-filter-overlay").style.display ===
        "flex"
          ? 1
          : 0
      ].firstChild;
  ...
  const handleResponsiveFilterClose = (e) => {
    ...
    const filter = document.getElementById("responsive-filter-container");
    if (
      overlay.classList.contains("responsive-filter-fixed-container-active")
    ) {
      overlay.classList.toggle("responsive-filter-fixed-container-active");
      filter.classList.toggle("responsive-filter-container-active");
    } else {
  ...
  useEffect(() => {
    ...
    if (responsiveItemView === "double" && mainSec) {
      ...
      doubleItemContainer.classList.remove(
        "double-item-symbol-container-active"
      );
  ...
  useEffect(() => {
    ...
    if (mainSec) {
      if (userScrollY > 50) {
        filterHead.style.boxShadow =
          "rgba(33, 35, 38, 0.1) 0px 12px 12px -10px";
      } else {
      ...
      if (mounted) {
        if (priceFilter) {
          (async () => {
            try {
              const response = await axios.get(
                `api/products/?gender=men&category=${productType}&priceFilter=${priceFilter}`,
                {
                  headers: {
                    "Content-Type": "application/json",
                  },
          ...
          (async () => {
            try {
              const response = await axios.get(
                `api/products/?gender=men&category=${productType}`,
                {
                  headers: {
                    "Content-Type": "application/json",
                  },
  ...
  if (isLoading) {
    return (
      <>
          ...
          <div id="filter-head" className="filter-header-container">
            ...
            <div className="active-filter-container">
              <div className="responsive-item-display-btn">
                <div
                  id="active-responsive-item-display"
                  className="active-responsive-item-display"
                ></div>
                <button
                  onClick={handleResponsiveItemViewChange}
                  className="responsive-single-item-view"
                >
                  <div
                    id="single-item-symbol"
                    className="single-item-symbol"
                  ></div>
                </button>
                <button
                  onClick={handleResponsiveItemViewChange}
                  className="responsive-double-item-view"
                >
                  <div
                    id="double-item-symbol-container"
                    className="double-item-symbol-container"
                  >
              ...
              <button
                onClick={
                  isLoading === true ? null : handleResponsiveFilterClick
                }
                className="responsive-filter-btn"
              >
                <i class="fa-solid fa-sliders"></i>{" "}
                <p>{windowWidth < 500 ? "FILTER" : "FILTER & SORT"}</p>
                {activeFilterTotal ? (
                  <div className="responsive-filter-bubble">
                    {activeFilterTotal}
                  </div>
                ) : (
                  <></>
              ...
              {priceFilter ? (
                <div
                  ...
                  className="filter-heading-contatiner"
                >
                  <p className="filter-heading">
                    <span>{priceFilter.toUpperCase()}</span>
                  </p>
              ...
              {sortByFilter ? (
                <div
                  onClick={handleSortByFilterRemove}
                  className="filter-heading-contatiner"
                >
                  <p className="filter-heading">
                    <span>{sortByFilter.toUpperCase()}</span>
                  </p>
                  <i className="fa-solid fa-x"></i>
                </div>
              ) : null}
              {sizeFilter ? (
                ...
                >
                  <p className="filter-heading">
                    <span>{sizeFilter.toUpperCase()}</span>
                  </p>
                  <i className="fa-solid fa-x"></i>
                </div>
              ) : null}
              {colorFilter ? (
                <div
                  onClick={handleColorFilterRemove}
                  className="filter-heading-contatiner"
                >
                  <p className="filter-heading">
                    <span>{colorFilter.toUpperCase()}</span>
                  </p>
                  <i className="fa-solid fa-x"></i>
                </div>
              ) : null}
              ...
              <div className="scroll-wrapper">
                <section className="shopping-dropdown-container">
                  <button
                    ...
                    className="shopping-collapsible first-coll font-bold"
                  >
                    CATEGORY
                  ...
                  <button
                    onClick={onCollapseClick}
                    className="shopping-collapsible font-bold"
                  >
                    STYLE
                    <div className="plus-minus-container">
                      <div className="thick-arrow-down"></div>
                      ...
                      <div class="radio-input-wrapper">
                        <label class="label">
                          <input
                            ...
                            checked={
                              priceFilter === "low to high" ? true : false
                            }
                            type="radio"
                            name="price-filter"
                            id="low-to-high"
                        ...
                        <label class="label">
                          <input
                            onChange={handlePriceFilterChange}
                            checked={
                              priceFilter === "high to low" ? true : false
                            }
                            type="radio"
                            name="price-filter"
                            id="high-to-low"
                      ...
                      <div class="radio-input-wrapper">
                        <label class="label">
                          <input
                            ...
                            checked={sortByFilter === "new" ? true : false}
                            type="radio"
                            name="sort-by"
                            id="new"
                            value="new"
                        ...
                        <label class="label">
                          <input
                            onChange={handleSortByFilterChange}
                            checked={sortByFilter === "sale" ? true : false}
                            type="radio"
                            name="sort-by"
                            id="sale"
                            value="sale"
                  ...
                  <div className="shopping-content">
                    <div className="filter-size-container">
                      <button onClick={handleSizeFilterChange} id="extra small">
                        XS
                      </button>
                      <button onClick={handleSizeFilterChange} id="small">
                        S
                      </button>
                      <button onClick={handleSizeFilterChange} id="medium">
                        M
                      </button>
                      <button onClick={handleSizeFilterChange} id="large">
                        L
                      </button>
                      <button onClick={handleSizeFilterChange} id="extra large">
                        XL
                      </button>
                    </div>
                  </div>
                  <button
                    id="last-coll"
                    onClick={onCollapseClick}
                    className="shopping-collapsible last-coll font-bold"
                  >
                    COLOR
                    <div className="plus-minus-container">
                      <div className="thick-arrow-down"></div>
        ...
        <div
          id="responsive-filter-overlay"
          className="responsive-filter-fixed-container"
        >
          <div
            onScroll={() => {
              ...
              if (container.scrollTop > 0) {
                header.style.boxShadow =
                  "rgba(33, 35, 38, 0.2) 0px 10px 10px -10px";
              } else {
            ...
            id="responsive-filter-container"
            className="responsive-filter-container"
          >
            <div
              id="responsive-filter-head"
              className="responsive-filter-header-container"
            >
              <h3>FILTER & SORT</h3>
              <i
                onClick={handleResponsiveFilterClose}
                className="fa-solid fa-x"
              ></i>
              <p
                onClick={handleClearAllFilters}
                className="responsive-filter-clear"
              >
                Clear All
              </p>
            </div>
            <div className="responsive-dropdown-wrapper">
              <section className="shopping-dropdown-container">
                ...
                <div className="shopping-content">
                  {product === "tops"
                    ? topsProductTypeBtns.map((btn, i) => btn)
                    : bottomsProductTypeBtns.map((btn, i) => btn)}
                </div>
                <button
                  onClick={onCollapseClick}
                  className="shopping-collapsible first-coll font-bold"
                  ...
                  <form action="">
                    <div class="radio-input-wrapper">
                      <label class="label">
                        <input
                          onChange={handlePriceFilterChange}
                          checked={priceFilter === "low to high" ? true : false}
                          type="radio"
                          name="price-filter"
                          id="low-to-high"
                          value="low to high"
                      ...
                      <label class="label">
                        <input
                          onChange={handlePriceFilterChange}
                          checked={priceFilter === "high to low" ? true : false}
                          type="radio"
                          name="price-filter"
                          id="high-to-low"
                          value="high to low"
            ...
            <div
              id="responsive-filter-footer"
              className="responsive-filter-footer-container"
            >
              {totalItems > 0 ? (
                ...
                <button disabled onClick={handleSeeProducts}>
                  SEE PRODUCTS ({totalItems})
                </button>
              )}
            </div>
        ...
        >
          ...
          <div id="filter-head" className="filter-header-container">
            ...
            <div className="active-filter-container">
              ...
              <button
                onClick={handleResponsiveFilterClick}
                className="responsive-filter-btn"
              >
                <i class="fa-solid fa-sliders"></i>{" "}
                <p>{windowWidth < 500 ? "FILTER" : "FILTER & SORT"}</p>
            ...
            <main className="products-container">
                ...
                {sortByFilter
                  ? colorFilter
                    ? products
                        .filter(sortByFunc)
                        .filter(
                          (productArr) => productArr.color === colorFilter
                        )
                        .map((product, i) => {
                          return (
                            <ProductCard
                              ...
                              setWishlistBubble={setWishlistBubble}
                  ...
                  : colorFilter
                  ? products
                      .filter((productArr) => productArr.color === colorFilter)
                      .map((product, i) => {
                        return (
                          <ProductCard
                            isLoggedIn={isLoggedIn}
              ...
              {totalItems === 0 ? (
                isLoading ? (
                  ...
                  <p>
                    No products found under those filters but keep checking,
                    they're coming soon!
                  </p>
                )
              ) : (
                ...
                >
                  <div className="responsive-filter-label-container">
                    ...
                    {priceFilter ? (
                      <div
                        onClick={handlePriceFilterRemove}
                        className="responsive-filter-heading-contatiner"
                      >
                        <p className="filter-heading">
                          <span>{priceFilter.toUpperCase()}</span>
                        </p>
