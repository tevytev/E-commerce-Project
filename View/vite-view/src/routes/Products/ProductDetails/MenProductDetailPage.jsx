...
export default function MenProductDetails(props) {
    ...
    const strikeThroughPrice = <p className="product-detail-price">${product.salePrice} <span className="line-through text-red-500 text-base">${product.price}</span></p>;
    const regularPrice = <p className="product-detail-price">${product.price}</p>;
            ...
            <main className="detail-main-container">
                ...
                <div className="product-image-container">
                    ...
                    <div className="gallery-container">
                        <img id="gallery-img-1" onClick={handleGalleryClick} className="active-gallery-image" src={memImageObj[productId][0]} alt="" />
                        <img id="gallery-img-2" onClick={handleGalleryClick} className="inactive-gallery-image" src={memImageObj[productId][1]} alt="" />
                        <img id="gallery-img-3" onClick={handleGalleryClick} className="inactive-gallery-image" src={memImageObj[productId][2]} alt="" />
                    </div>
                </div>
                <div onScroll={() => {
                    ...
                    <img className="small-desktop-image" src={memImageObj[productId][0]} alt="" />
                    <img className="small-desktop-image" src={memImageObj[productId][1]} alt="" />
                    <img className="small-desktop-image" src={memImageObj[productId][2]} alt="" />
                </div>
                ...
                <div className="product-info-container">
                    <div>
                        ...
                        <h1 className="product-detail-header">{product.name ? product.name.toUpperCase() : product.name}</h1>
                    </div>
                    <div className="mt-2">
                        <p className="font-light text-xs text-red-500">HALF PRICE EXPRESS SHIPPING!*<br />DISCOUNT APPLIED!</p>
                        <p className="product-detail-price">{product.salePrice ? strikeThroughPrice : regularPrice}</p>
                        <p className="mt-2">COLOR: <span className="">{product.color ? product.color.toUpperCase() : product.color}</span></p>
                        <p className="mt-2">SIZE: <span className="">{sizeToDisplay}</span></p>
                    </div>
