...
export default function ResponsiveNav(props) {
    ...
    const [activeProductType, setActiveProductType] = useState('nav-women');
        ...
        return (
            ...
            <div id='responsive-nav-container' style={{display: 'none'}} className='responsive-nav-container'>
                <div className='responsive-nav-header-container'>
                    <div className='responsive-nav-header-top-container'>{userData ? 'Hi, ' + userData.userName : <></> }<i onClick={handleNavClose} className="fa-solid fa-x"></i></div>
                    <div className='responsive-nav-header-top-container'>
                        <Link onClick={handleNavClose} to={'/wishlist'}><i className="fa-regular fa-heart mr-4"></i></Link>
                    </div>
                    <h3>SHOP</h3>
        ...
        return (
            ...
            <div id='responsive-nav-container' style={{display: 'none'}} className='responsive-nav-container'>
                <div className='responsive-nav-header-container'>
                    <div className='responsive-nav-header-top-container'>
                        <i className="fa-regular fa-heart mr-4"></i>
                        <i onClick={handleNavClose} className="fa-solid fa-x"></i>
                    </div>
                    <h3>SHOP</h3>
                    <div onClick={handleSearchClick} className='responsive-nav-searchbar-btn'>
                        <i class="fa-solid fa-magnifying-glass text-base"></i>
                ...
                <div className='responsive-nav-body-container'>
                    ...
                    <div className='responsive-nav-featured-container'>
                        <Link id='responsive-nav-new-release-women' className='responsive-nav-featured-item'>
                            <div></div>
                            <p>NEW RELEASES</p>
                        </Link>
                        <Link id='responsive-nav-sale-women' className='responsive-nav-featured-item'>
                            <div></div>
                            <p>ON SALE THIS MONTH</p>
                        </Link>
                    </div>
                    <div className='responsive-nav-products-header'>
                        <h3>MENS PRODUCTS</h3>
                    </div>
                    <section className="responsive-nav-dropdown-container">
                        <button onClick={handleCollapseClick} class="responsive-nav-collapsible font-semibold">TRENDING
